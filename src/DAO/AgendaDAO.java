...
public class AgendaDAO {
    ...
    public boolean add(Agenda a){
        String sql = "INSERT INTO AGENDA(NOME_CLIENTE,TELEFONE_CLIENTE,DATAHORA_SERVICO,REGISTRO,NOME_SERVICO,STATUS) VALUES(?,?,?,?,?,?);";
            ...
            try {
                ...
                stmt.setString(6, String.valueOf(a.getStatus()));
                stmt.execute();
                stmt.close();
                con.close();
                return true;
    ...
    public boolean update(Agenda a){
        String sql = "UPDATE AGENDA SET NOME_CLIENTE = ? , TELEFONE_CLIENTE = ? ,DATAHORA_SERVICO = ?,NOME_SERVICO = ?, STATUS = ? WHERE REGISTRO = ?;";
            ...
            try {
                ...
                stmt.setString(5,String.valueOf(a.getStatus()));
                stmt.setLong(6, a.getRegistro());
                stmt.execute();
                stmt.close();
                con.close();
                return true;
